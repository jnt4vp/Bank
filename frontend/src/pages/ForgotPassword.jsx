      ...
      <div style={{
        ...
        {submitted ? (
          <div className="login-card" style={{ textAlign: "center", maxWidth: "360px" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "24px", color: "#2e1f08", marginBottom: "12px" }}>Check your email</h2>
            <p style={{ fontSize: "14px", color: "rgba(60,45,20,0.75)", lineHeight: 1.7, marginBottom: "20px" }}>
          ...
          <form className="login-card" onSubmit={handleSubmit} style={{ maxWidth: "360px" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "24px", color: "#2e1f08", marginBottom: "6px" }}>Forgot Password</h2>
